...
项目提供了 [qemu-run.sh](https://github.com/Awesome-Embedded-Learning-Studio/PenguinLab/blob/main/scripts/qemu-run.sh) 脚本来简化 QEMU 的启动参数，它自动检测编译输出目录里的内核镜像和 rootfs 文件。运行方式很简单：
